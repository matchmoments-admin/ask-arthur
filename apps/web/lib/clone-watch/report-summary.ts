...
export function summaryRow(
  ...
  const row: Record<string, unknown> = {
    ...
    taken_down: card.kpis.takenDown,
    declined: card.kpis.declined,
    escalated: card.kpis.escalated,
    weaponised: card.kpis.weaponised,
    re_taken_down: card.kpis.reTakenDown,
