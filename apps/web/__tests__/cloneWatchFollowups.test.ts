...
describe("buildInternalDigestHtml", () => {
    ...
    domains: over.domains ?? [
      {
        ...
        lifecycle_state: null, first_seen_at: null, screenshot_url: null, result_url: null, still_live_as_of: null, risk_score: null,
      },
    ],
  ...
  it("escapes HTML in domain values", () => {
    const byBrand = new Map<string, CloneBrandMetrics>([
      ["x.com", metrics({ domains: [{ domain: "a<script>.com", classification: null, ip: null, asn: null, country: null, registrar: null, abuse_email: null, lifecycle_state: null, first_seen_at: null, screenshot_url: null, result_url: null, still_live_as_of: null, risk_score: null }] })],
    ]);
    const html = buildInternalDigestHtml("June 2026", byBrand);
    ...
    const byBrand = new Map<string, CloneBrandMetrics>([
      [
        ...
        metrics({
          ...
          domains: [
            { domain: "anz-a.click", classification: null, ip: null, asn: null, country: null, registrar: "NameSilo", abuse_email: "abuse@namesilo.com", lifecycle_state: null, first_seen_at: null, screenshot_url: null, result_url: null, still_live_as_of: null, risk_score: null },
          ],
        }),
      ],
    ]);
  ...
  it("sums per-brand registrar counts across brands, maps abuse emails, and counts Unknown", () => {
    const byBrand = new Map<string, CloneBrandMetrics>([
      ["a.com", m({ NameSilo: 2, Unknown: 1 }, [
        { domain: "a1", classification: null, ip: null, asn: null, country: null, registrar: "NameSilo", abuse_email: "abuse@namesilo.com", lifecycle_state: null, first_seen_at: null, screenshot_url: null, result_url: null, still_live_as_of: null, risk_score: null },
      ])],
      ["b.com", m({ NameSilo: 3, GoDaddy: 1 }, [
        { domain: "b1", classification: null, ip: null, asn: null, country: null, registrar: "GoDaddy", abuse_email: "abuse@godaddy.com", lifecycle_state: null, first_seen_at: null, screenshot_url: null, result_url: null, still_live_as_of: null, risk_score: null },
      ])],
    ]);
