...
- **Versioned migration SQL** — `migration-v<N>-<slug>.sql` files (currently v2 through v288+). Apply with `mcp__supabase__apply_migration` against project `rquomhcgnodxzkhokwni`.
