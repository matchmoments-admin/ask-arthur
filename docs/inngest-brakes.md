...
| `shopfront-clone-netcraft-issue`          | cron daily 11:00 UTC + manual                        | 1 (singleton) | `NETCRAFT_ISSUE_DAILY_CAP` 10/d | —      | —                        | `cloneNetcraftIssue`                             | ✓           | `clone_netcraft_issue` (+autobrake) |
