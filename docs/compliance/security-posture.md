...
- **Extension auth:** Per-install ECDSA P-256 signature (install-specific non-extractable keypair, Cloudflare Turnstile-gated registration, ±5 min skew window, Redis nonce-replay protection).
