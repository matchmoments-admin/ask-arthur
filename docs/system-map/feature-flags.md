...
| `monthlyIntelBlog` (`FF_MONTHLY_INTEL_BLOG`)                 | OFF                         | Monthly intel-driven blog draft (`monthly-intel-blog` Inngest fn, 2nd of month, 20:00 UTC). Mines the prior month across Reddit intel / competitor observations / clone-watch / regulator feeds / consumer reports → Sonnet 4.6 → Ghost draft (blog_posts fallback) + admin Telegram nudge. Never auto-publishes. Replaced the retired weekly-blog Vercel cron. Cost feature `monthly_intel_blog`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
