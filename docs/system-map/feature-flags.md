...
| ---------------------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `documentCheck`        | OFF     | Document Check Module — public `/document-check` page + `/api/document-check` (deterministic PDF structural forensics, web-only consumer surface, no paid APIs; `NEXT_PUBLIC_FF_DOCUMENT_CHECK`)                                                                                                                                                                                                |
