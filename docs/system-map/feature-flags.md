...
| ---------------------- | ------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `documentCheck`        | OFF     | Document Check Module — public `/document-check` page + `/api/document-check` (deterministic PDF structural forensics + AU ABN pack, web-only consumer surface, no paid APIs; `NEXT_PUBLIC_FF_DOCUMENT_CHECK`)                                                                                                                                                                                  |
