...
| `SHOP_SIGNAL_CAP_USD`        | `15`    | _Planned, not yet wired_ — Stage 1 PR 2 (#319) — `cost_telemetry WHERE feature IN ('shop_signal', 'shop-signal-apivoid-error', 'shop-signal-apivoid-overage')`. See [`docs/ops/shop-signal-config.md`](../ops/shop-signal-config.md) §3 for derivation. |
