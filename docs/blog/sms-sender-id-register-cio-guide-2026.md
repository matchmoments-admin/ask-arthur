...
> [!DANGER]
> From 1 July 2026, your customer's phone will display your transactional SMS — the password reset, the appointment reminder, the 2FA code — with the word **Unverified** attached, unless you have registered. Your churn risk and your inbound support volume will both move on day one. This is not a back-office compliance task; it is a customer-trust event.
...
> [!WARNING]
> The 1 July 2026 simultaneity is **not an accident**. Treasury, ACMA, and the Attorney-General co-ordinated the timeline so that compliance teams cannot treat any of the three regimes in isolation. If your SMS architecture is not registered on 1 July, it is the easiest possible compliance failure for a regulator to find — and it lands the same week as the SPF Act's first enforcement window opens.
...
> [!TIP]
> Run the inventory **before** the registration. Most enterprise SMS senders discover they use more sender ID strings than their compliance team has on file — historic legacy strings, regional variations, A/B test strings, and brand acquisitions are all common gaps. Find the gaps before ACMA does.
