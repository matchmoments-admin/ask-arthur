...
| `report-onward-markers`         | One multi-trigger fn (consolidated 2026-07-12 fleet review) covering scamwatch / reportcyber / idcare / ask-arthur-feed. Scamwatch + ReportCyber mark `skipped` with `status_reason='no_api_user_redirect_required'` (UI surfaces deep-link + clipboard-prefilled evidence block); IDCARE marks `skipped` + phone 1800 595 160; ask-arthur-feed marks `sent` (audit marker only). No external API call. |
