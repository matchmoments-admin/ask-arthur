<!-- Hero image: /illustrations/extension-launch.webp -->

# Ask Arthur is now on Chrome: detect scam ads and dodgy sellers on Facebook before you get burned
...
1. Visit the [Ask Arthur page on the Chrome Web Store](#) <!-- Replace with actual Chrome Web Store URL -->
2. Click **Add to Chrome**
3. Click **Add extension** in the popup
4. You'll see the Ask Arthur icon in your toolbar — that's it, you're protected
...
Here's what happens behind the scenes when you're browsing Facebook:

**Sponsored posts**: When you scroll your feed, Ask Arthur checks every sponsored post against our threat intelligence database and AI analysis. If something looks off — a fake domain, a too-good-to-be-true offer, a known scam pattern — you'll see a clear warning banner right on the ad. No clicking required.

**Marketplace listings**: When you open a listing, Ask Arthur looks at the seller's profile. How old is the account? Do they have ratings? Does their listed location match up? You'll see a trust badge (green, amber, or red) so you can make an informed decision before handing over any money.
...
All of this happens locally in your browser. We don't read your private messages. We don't store your conversations. We just pattern-match against known scam tactics.
...
Ask Arthur is built on a zero-knowledge architecture. We analyse what you ask us to analyse, give you an answer, and forget about it.
...
If you've got parents or grandparents who use Facebook, this is the single most useful thing you can do to protect them. Install it on their computer next time you visit. It works silently in the background — they don't need to do anything differently.

### Marketplace buyers and sellers

If you buy or sell on Facebook Marketplace, seller trust scores and PayID scam detection are built for you. No more guessing whether a buyer is legitimate.
...
### People worried about deepfake ads

If you've ever wondered whether that celebrity investment ad is real, Ask Arthur is training AI to spot the fakes so you don't have to guess.
...
- **Mobile app** — the same protection on your phone (already in development)
...
**[Install Ask Arthur from the Chrome Web Store](#)** <!-- Replace with actual Chrome Web Store URL -->

It's free, it's private, and it takes half a minute.

If you find it useful, share it with someone you care about. The more Australians using Ask Arthur, the harder it gets for scammers to operate.

---

[askarthur.au](https://askarthur.au)

*Protecting Australians from scams, one check at a time.*
