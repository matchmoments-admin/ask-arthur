...
This package has no `typecheck` or `test` script of its own — it's thin factories. Coverage and typechecking come from consumer packages (e.g. `pnpm --filter @askarthur/web typecheck`).
