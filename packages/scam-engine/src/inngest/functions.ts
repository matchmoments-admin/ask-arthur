...
// Scraper cost audit: nightly per-scraper runtime + new-row telemetry →
// scraper_telemetry (v139). 02:10 UTC.
import { scraperCostAudit } from "./scraper-cost-audit";
...
export const inngestFunctions = [
  ...
  // Scraper cost audit: nightly per-scraper runtime + row telemetry (v139)
  scraperCostAudit,
