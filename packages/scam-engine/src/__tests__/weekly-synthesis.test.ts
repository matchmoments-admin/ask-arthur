...
describe("aggregateWeeklyCohort", () => {
    ...
    const cohort = [
      {
        ...
        brands_impersonated: ["Auspost", "ATO"],
        tactic_tags: [],
      },
      {
        intent_label: "phishing",
        brands_impersonated: ["Auspost"],
        tactic_tags: [],
      },
      {
        intent_label: "romance_scam",
        brands_impersonated: [],
        tactic_tags: [],
      },
    ];
  ...
  it("flags brands/tactics absent from the baseline as novel (case-insensitive)", () => {
    const cohort = [
      {
        intent_label: "phishing",
        brands_impersonated: ["Booking.com"],
        tactic_tags: ["qr-code"],
      },
      {
        intent_label: "phishing",
        brands_impersonated: ["ATO"],
        tactic_tags: ["fake-invoice"],
      },
    ];
