...
| Breach Defence — plan        | [/Users/brendanmilton/.claude/plans/humble-noodling-anchor.md](/Users/brendanmilton/.claude/plans/humble-noodling-anchor.md) — 19-PR build sequence (F1–F11), migration renumbering (v80–v86), spec-vs-codebase corrections. The detailed source spec lives in the `feat: Breach Defence Suite` PR description and conversation history. |
