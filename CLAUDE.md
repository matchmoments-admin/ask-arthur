...
| Shop Signal — ops config       | [docs/ops/shop-signal-config.md](./docs/ops/shop-signal-config.md) — Stage 0 pre-flip checklist, APIVoid pricing tiers + cap derivation, `feature_brakes.shop_signal` SQL block drafted for Stage 1 PR 2 (#319) to lift. Stage 0/0.5 shipped 2026-05-19 (#324/#325); `FF_SHOP_SIGNAL` default OFF — flip starts the 30-day measurement window in `docs/ops/shop-signal-measurement.md`. Plan: [docs/plans/shop-guard-v2.md](./docs/plans/shop-guard-v2.md).                                                                                                                                                                                                                                                                     |
